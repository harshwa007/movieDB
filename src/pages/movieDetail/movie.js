...
const Movie = () => {
    ...
    <h2 className="castHeader">cast</h2>
    <div style={{ display: 'flex', flexWrap: 'wrap', marginLeft:'10%'}}>
      {cast.map((member, index) => (
        <div key={member.id} style={{ width: '15%' }}>
          <img className="cast_img" src={`https://image.tmdb.org/t/p/w500${member.profile_path}`} alt={member.name}  />
          <h3>{member.name}</h3>
